...

{
    ...
    is( $fields[0], 'id_instrument_status',
        '$fields[0] is id_instrument_status' );
    is( $fields[1], 'id_instrument', '$fields[1] is id_instrument' );
    is( $fields[2], 'date',          '$fields[2] is date' );
    is( $fields[3], 'id_instrument_status_dict',
        '$fields[3] is id_instrument_status_dict' );
    ...
    my $test_deeply = [
        {
            name     => 'IL10',
            statuses => [
                { date => '2007-09-20 15:02:53', description => 'up' },
                { date => "2009-02-03 12:25:32", description => "down" }
            ],
        },
        {
            name     => 'IL2',
            statuses => [
                { date => "2007-09-19 13:09:42", description => "up" },
                { date => "2009-02-03 12:25:32", description => "down" }
            ],
        },
        {
            ...
            statuses => [
                { date => "2007-09-19 13:09:42", description => "up" },
                { date => "2007-10-02 11:02:52", description => "down" }
            ],
        },
        {
            name     => 'IL4',
            statuses => [
                { date => "2007-09-19 13:09:41", description => "up" },
                { date => "2007-09-19 13:10:53", description => "down" }
            ],
        },
        {
            name     => 'IL6',
        ...
        },
        {
            ...
            statuses => [
                { date => "2007-09-19 13:09:41", description => "up" },
                { date => "2007-09-20 15:00:53", description => "down" },
                { date => "2007-10-02 11:02:52", description => "up" },
                { date => "2009-02-03 12:25:32", description => "down" }
            ],
        },
        {
        ...
        },
        {
            ...
            statuses => [
                { date => "2007-09-19 13:09:41", description => "up" },
                { date => "2007-09-20 15:02:52", description => "down" },
                { date => "2007-10-02 11:02:52", description => "up" },
                { date => "2009-02-03 12:25:32", description => "down" }
            ],
        },
    ...
    is_deeply( $instruments, $test_deeply,
        'correct data structure obtained from $i_s->uptimes()' );
