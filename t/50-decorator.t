...
is( $decorator->username(),
    q{}, q{empty string returned when no username provided or cached} );
is( $decorator->username('test_user'),
    q{test_user}, q{test_user passed in to username and returned} );
