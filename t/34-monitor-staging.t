...

{
    ...
    my $mtest = Monitor::Staging->new(
        _schema     => $schema,
        known_areas => \@staging_areas
    );
    my @val_area_output;
    ...
    qr/Parameter[ ]out[ ]of[ ]bounds:[ ]/msx, 'Warn for out of bounds index...';

    warning_like {
        push @val_area_output, $mtest->validate_areas( 2, '/no/such/dir' );
    }
