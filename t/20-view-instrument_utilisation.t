...
my $util = t::util->new( { fixtures => 1, cgi => CGI->new() } );
{
    ...
    like(
        $EVAL_ERROR,
        qr{You\ \(public\)\ are\ not\ authorised\ for\ this\ view},
...
}
{
    ...
    ok(
        $util->test_rendered(
            $str, 't/data/rendered/instrument_utilisation/create.xml'
        ),
        'pipeline create ok'
    );
}

{
    ...
    ok(
        $util->test_rendered(
            $str, 't/data/rendered/instrument_utilisation/list.html'
        ),
        'table list view ok'
    );
}

{
    ...
    ok(
        $util->test_rendered(
            $str, 't/data/rendered/instrument_utilisation/list_graphical.html'
        ),
...

{
    ...
    ok(
        $util->test_rendered(
            $str,
            't/data/rendered/instrument_utilisation/list_graphical_90days.html'
        ),
        'graphical list view ok'
    );
}
