...
is( $test->get_element_content( $xml_doc, 'dummy' ),
    q{}, 'Empty string for no match' );

is( $test->get_element_content( $xml_doc, 'count_me' ),
    q{Example}, 'Return content otherwise' );
