...
##########
    ...
    is( $view->authorised(), undef,
        'create xml aspect/create action - public not authorised' );
    $view->action('update');
...

{
    ...
    ok(
        $util->test_rendered(
            $render,
            't/data/rendered/20-view-run_lane_annotation_not_bad_lane.html'
        ),
        'create render'
    );
}

{
    ...
    ok(
        $util->test_rendered(
            $render,
            't/data/rendered/20-view-run_lane_annotation_bad_lane_not_last.html'
        ),
        'create render with bad lane but not last lane'
    );
}

{
    ...
    ok(
        $util->test_rendered(
            $render,
            't/data/rendered/20-view-run_lane_annotation_bad_lane_and_last.html'
        ),
        'create render with bad lane and is the last lane'
    );
}

{
    ...
    ok(
        $util->test_rendered(
            $render,
            't/data/rendered/20-view-run_lane_annotation_add_ajax.html'
        ),
        'create render with bad lane and is the last lane'
    );
}
