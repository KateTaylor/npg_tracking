...
{
    no warnings;
    local *npg_tracking::Schema::Result::EventType::_count = sub { return 2; };
    use warnings;
    ...
    no warnings;
    local *npg_tracking::Schema::Result::EventType::_count = sub { return 0; };
    use warnings;

    is( $test->id_query( 6, 'status change' ),
        undef, 'Return undef for no matches' );
}
