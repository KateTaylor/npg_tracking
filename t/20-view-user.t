...

{
    ...
    ok( $util->test_rendered( $view->render(), 't/data/rendered/user.html' ),
        '20-view-user-list rendered ok' );
}

{
    ...
    ok( $util->test_rendered( $str, 't/data/rendered/user/1000.html' ),
        '20-view-user-read rendered ok' );
}
