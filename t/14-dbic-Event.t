...
my $sql =
  'SELECT notification_sent' . ' FROM event' . " WHERE id_event = $new_row_id";
...
is( $test->notification_sent()->datetime,
    '2010-09-21T11:19:25', 'notification_sent returned correctly' );
