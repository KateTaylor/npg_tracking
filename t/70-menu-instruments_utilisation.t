...

{
    ...
    ok(
        $util->test_rendered(
            $str,
            't/data/rendered/menus/instruments_utilisation_30days_textual.html'
        ),
...

{
    ...
    ok(
        $util->test_rendered(
            $str,
            't/data/rendered/menus/instruments_utilisation_30days_barchart.html'
        ),
...

{
    ...
    ok(
        $util->test_rendered(
            $str,
            't/data/rendered/menus/instruments_utilisation_30days_lineplot.html'
        ),
...

{
    ...
    ok(
        $util->test_rendered(
            $str,
            't/data/rendered/menus/instruments_utilisation_90days_textual.html'
        ),
...

{
    ...
    ok(
        $util->test_rendered(
            $str,
            't/data/rendered/menus/instruments_utilisation_90days_lineplot.html'
        ),
...

{
    ...
    ok(
        $util->test_rendered(
            $str, 't/data/rendered/menus/instruments_utilisation_uptime.html'
        ),
        'menu instruments>utilisation>uptime'
    );
}
