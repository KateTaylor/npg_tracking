...

{
    ...
    is( $model->is_member_of('engineers'),
        1, 'admin user is_member_of engineers' );
}

{
    ...
    is( $model->is_member_of('admin'),
        undef, 'engineer user is not member of admin' );
    is( $model->is_member_of('engineers'),
        1, 'admin user is_member_of engineers' );
}

{
    ...
    is( $model->is_member_of('admin'),
        undef, 'analyst user is not member of admin' );
    is( $model->is_member_of('analyst'),
        1, 'analyst user is_member_of analyst' );
}

{
    ...
    is(
        $model->rfid(),
        q{a07c54b988516a16f305aa7d483bb2cf5a496f167ea13548cf2222c5125499e6},
        q{correct sha string returned by rfid}
    );
}
...

{
    ...
    is(
        $model->rfid(),
        q{d168639a64be86ec756c120fe5acb664a4c8a60f3a4b380a534c615a554d4b34},
        q{rfid has been altered on object creation}
    );
    lives_ok {
        $model->update();
    }
...
}
{
    ...
    is(
        $model->rfid(),
        q{d168639a64be86ec756c120fe5acb664a4c8a60f3a4b380a534c615a554d4b34},
        q{rfid has been modified externally}
    );
    lives_ok {
        $model->update();
    }
