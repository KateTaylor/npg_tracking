...
is_deeply(
    $watchers,
    [
        qw{full@address.already joe_engineer@sanger.ac.uk joe_results@sanger.ac.uk}
    ],
    q{watchers are is correct}
);
...
is(
    $email->{subject},
    q{Run Lane 1_7 has been annotated by pipeline} . qq{\n},
    q{subject is correct}
);
is(
    $email->{to},
    q{full@address.already, joe_engineer@sanger.ac.uk, joe_results@sanger.ac.uk}
      . qq{\n},
