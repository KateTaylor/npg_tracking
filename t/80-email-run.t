...
my $hash_projects_followers = {
    '500 Exome' => {
        'followers' => [
            'ajc@sanger.ac.uk', 'dw2@sanger.ac.uk',
            'ekh@sanger.ac.uk', 'fp1@sanger.ac.uk',
...

{
    ...
    my $id_run = 4231;
    lives_ok {
        $object = npg::email::run->new( { schema_connection => $schema, } );
    }
    q{object created ok};
    is_deeply( $object->study_lane_followers($id_run),
        $hash_projects_followers, q{hash obtained is correct} );
}
