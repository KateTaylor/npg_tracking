...
{
    $validation =
      npg_tracking::illumina::run::folder::validation->new(
        run_folder => '100505_IL45_4655', );
    ok( !$validation->check,
        'Run folder 100505_IL45_4655 NOT match 100429_IL38_4655 from npg' );
}

{
    ...
    ok( $validation->check,
        'Run folder 100505_IL45_4655 match 100429_IL38_4655 from npg' );
}

{
    ...
    ok( $validation->check,
        'Run folder 100505_IL45_4655 not checked from npg' );
}
