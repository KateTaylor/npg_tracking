...

{
    ...
    ok(
        $util->test_rendered(
            $render, 't/data/rendered/20-view-administration_list_public.html'
        ),
    ...
    ok(
        $util->test_rendered(
            $render,
            't/data/rendered/20-view-administration_list_engineers.html'
        ),
    ...
    ok(
        $util->test_rendered(
            $render, 't/data/rendered/20-view-administration_list_admin.html'
        ),
...

{
    ...
    like(
        $EVAL_ERROR,
        qr{not\ authorised\ for\ this\ view },
...

{
    ...
    ok(
        $util->test_rendered(
            $render, 't/data/rendered/20-view-administration_create_user.html'
        ),
...

{
    ...
    like(
        $EVAL_ERROR,
        qr{No\ entity\ type\ given},
        'croaked - no entity type given'
    );
    $cgi->param( 'description', 'test' );
    $cgi->param( 'iscurrent',   1 );
    $view = npg::view::administration->new(
    ...
    ok(
        $util->test_rendered(
            $render,
            't/data/rendered/20-view-administration_create_entity_type.html'
        ),
        'create_entity_type renders ok'
    );
}
...

{
    ...
    like(
        $EVAL_ERROR,
        qr{No\ user\ and\/or\ usergroup\ given},
        'croaked - no user given'
    );
    $cgi->param( 'id_user',      1 );
